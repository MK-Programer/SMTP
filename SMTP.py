...
recv = clientSocket.recv(1024) #amount of data recieved
...
recv1 = clientSocket.recv(1024) #amount of data recieved
...
recv1 = clientSocket.recv(1024) #total size of the msg
